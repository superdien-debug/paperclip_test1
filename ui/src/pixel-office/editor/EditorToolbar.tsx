...
interface EditorToolbarProps {
  ...
  onFurnitureTypeChange: (type: string | null) => void;
...
export function EditorToolbar({
  ...
  return (
    ...
    >
      ...
      {/* Selected furniture color panel — shows when an item is selected or being placed */}
      {(selectedFurnitureUid || activeTool === EditTool.FURNITURE_PLACE) && (
